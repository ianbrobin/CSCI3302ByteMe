...
class CalculateBestMoveRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CalculateBestMoveRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CalculateBestMoveRequest
    let len;
    let data = new CalculateBestMoveRequest(null);
  ...
  static datatype() {
    ...
    return 'TicTac/CalculateBestMoveRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CalculateBestMoveRequest(null);
...
class CalculateBestMoveResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.output = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CalculateBestMoveResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CalculateBestMoveResponse
    let len;
    let data = new CalculateBestMoveResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'TicTac/CalculateBestMoveResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CalculateBestMoveResponse(null);
...
module.exports = {
  Request: CalculateBestMoveRequest,
  Response: CalculateBestMoveResponse,
  md5sum() { return 'd8b7e9905e6a815639dc67959117aa3b'; },
  datatype() { return 'TicTac/CalculateBestMove'; }
};
